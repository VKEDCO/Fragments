...
public class QuatrainTextDisplayFragment extends Fragment {
	...
	public static QuatrainTextDisplayFragment newInstance(Bundle bundle) {
		Log.d(LOGTAG, "newInstance(Bundle)");
		final String key = RumiQuatrainMainActivity.mRes.getString(R.string.quat_index_key);
		if ( bundle.containsKey(key) ) {
			Log.d(LOGTAG, "key = " + bundle.getInt(key));
		}
		else {
			Log.d(LOGTAG, "key = null");
		}
    ...
    public void onCreate(Bundle myBundle) {
    	...
    	if(myBundle != null) {
            ...
            for(String key : myBundle.keySet()) {
                Log.d(LOGTAG, "    " + key + " --> " + myBundle.getInt(key));
                mQuatrainIndex = getArguments()
        				.getInt(RumiQuatrainMainActivity.mRes.getString(R.string.quat_selection_key),
        						0);
            }
    	}
    	else {
	...
	public View onCreateView(LayoutInflater inflater,
        ...
        // if the container is empty, simply return
        if(container == null) {
    ...
    public void onActivityCreated(Bundle savedState) {
    	...
    	if(savedState != null) {
            ...
            for(String key : savedState.keySet()) {
                Log.d(LOGTAG, "    " + key + " --> " + savedState.getInt(key));
            }
            mQuatrainIndex = getArguments()
    				.getInt(RumiQuatrainMainActivity.mRes.getString(R.string.quat_selection_key),
    						0);
    ...
    public void onSaveInstanceState(Bundle outState) {
    	...
    	outState.putInt(RumiQuatrainMainActivity.mRes.getString(R.string.quat_selection_key), mQuatrainIndex);
    }
